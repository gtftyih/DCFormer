...
from model.STAFormer import Model
...
def get_pose3D(video_path, output_dir):
    ...
    model_path = sorted(glob.glob(os.path.join(args.previous_dir)))[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--previous_dir',type=str, default='./checkpoint/model_27_DCFormer/no_refine_staf_9_4378.pth', help='checkpoint')
