...
class Model(nn.Module):
    def __init__(self, args=None, in_dim=2, out_dim=1):
        super().__init__()
    ...
    def forward(self, x, is_3dhp=False):
...
class STAF_ATTENTION(nn.Module):
    ...
    def forward(self, input):
        ...
        x_s = att_s @ v_s + hdpe_s + 1e-3 * self.drop(ldpe_s)               # b*h*t,s,c//2//h 
...
class STAF_BLOCK(nn.Module):
    def __init__(self, d_time, d_joint, d_coor):
        ...
        self.staf_att2 = STAF_ATTENTION(d_time, d_joint, d_coor)
