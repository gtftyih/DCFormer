...
if __name__ == '__main__':
    ...
    model = {}
    model['pre'] =  nn.DataParallel(Model_scale_c(opt,2,pre_dict_pre['module.regress_head.weight'].shape[0])).cuda()
    model['trans'] =  nn.DataParallel(Model_depth_c(opt,2,pre_dict['module.regress_head.weight'].shape[0])).cuda()
